...
<div class="w-1/8 flex flex-col overflow-hidden bg-white p-4">
    ...
    <a href="{{route('players.create')}}" class="bg-gray-500 hover:bg-black text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded text-center">New Player</a><br/><br/>
