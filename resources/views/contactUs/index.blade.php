        ...
        <div class="mx-auto w-full max-w-[550px]">
            <form action="{{ route('contactUs.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="subject" id="subject" placeholder="Enter your subject" class="w-full rounded-md border border-gray-500 bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    @error('subject')
                        <p><strong>{{ $message }}</strong></p>
                    @enderror
                    <br>
