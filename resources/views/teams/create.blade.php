                    ...
                    <div class="p-6 sm:p-16">
                        ...
                        <form action="{{route('teams.store')}}" method="POST" class="mx-5 my-5">
                            ...
                            <p class="text-black text-sm font-normal flex gap gap-2 pt-2">
                                <div class="relative">
                                    <select class="group h-10 px-6 border-2 border-gray-300 rounded-lg transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100" type="text" name="category" value="{{old('category')}}">
                            ...
                            <Button type="submit" class="mt-5 border-2 px-5 py-2 rounded-lg border-gray-500 bg-gray-200 hover:bg-blue-400 hover:border-blue-400 border-b-4 font-black translate-y-2 border-l-4">Submit</Button>
                        </form>
                    </div>
            </div>
        </div>
