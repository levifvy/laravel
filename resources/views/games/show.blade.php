...
<div class="bg-gradient-to-r from-blue-900 to-red-900">
    <div class="italic text-white p-3">
        <strong>Match was created in:</strong> {{ $game->game_date }}
    </div>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="grid grid-cols-3 gap-4">
            <div>
                <div class="text-center">
                    <h2 class="text-5xl font-bold text-white">{{ $game->team1->name }}</h2>
                    <form method="POST" action="" class="mt-4 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" for="matches">
                        @csrf
                        <div class="grid grid-cols-4" title="category">
                            <div class="col-start-1">
                                <p class="text-gray-700 font-bold text-start">{{ $game->category->name }}</p>
                                <input type="hidden" name="category_id" value="{{ $game->category->id }}">
                            </div>
                        </div>
                        <div class="grid justify-items-end">
                            <div class="mb-4 flex justify-center">
                                <label class="block text-gray-700 font-bold mb-2" for="goals">Goals:</label>
                            ...
                            <div class="mb-4 flex justify-center">
                                <label class="block text-gray-700 font-bold mb-2" for="fouls_commited">Fouls committed:</label>
                            ...
                            <div class="mb-4 flex justify-center">
                                <label class="block text-gray-700 font-bold mb-2" for="yellow_cards">Yellow cards 🟨:</label>
            ...
            <div>
                <div class="text-center">
                    <h2 class="text-5xl font-bold text-white">{{$game->team2->name}}</h2>
                    <form method="POST" action="{{ route('fixtures5') }}" class="mt-4 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" for="games">
                        @csrf
                        <div class="grid grid-cols-3 gap-4">
