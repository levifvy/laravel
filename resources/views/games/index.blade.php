...
@section('content')
<div class="bg-image">
    <div class="grid place-items-center z-9 p-20">
        <div class="grid lg:w-6/6">
            <div class="bg-white shadow-md rounded my-1">
                <table class="min-w-max w-full table-auto">
                    <thead class="">
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            <th class="py-3 px-6 text-center">Team 1</th>
                            <th class="py-3 px-6 text-center">Team 2</th>
                            <th class="py-3 px-6 text-center">Category</th>
                            <th class="py-3 px-6 text-center">Actions</th>
                            <th class="py-3 px-6 text-center">PLay</th>
                        </tr>
                    </thead>
                    <tbody class="text-gray-600 text-sm font-light">
                        @foreach($games as $game)
                            <tr class="border-b border-gray-200 hover:bg-blue-200">
                                <a href="{{ route('games.show', $game) }}" title="view">
                                    ...
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        <a href="{{ route('games.show', $game) }}" title="view">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-base font-semibold">{{ $game->category->name }}</span>
                                            </div>
                                        </a>
                                    </td>
                                </a>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center space-x-4">
                                        ...
                                        <a href="{{ route('games.edit', $game) }}" title="view">
                                            <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <form action="{{ route('games.destroy', $game) }}" method="POST" class="d-inline" title="delete">
                                            @csrf
                                            @method('DELETE')
